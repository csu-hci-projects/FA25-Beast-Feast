...
namespace KinematicCharacterController.Examples
{
    ...
    public class ExampleCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        public void UpdateRotation(ref Quaternion currentRotation, float deltaTime)
        {
            ...
            private float _normalizedForwardSpeed = 0f;
            ...
            public float NormalizedForwardSpeed{
                get{
                    return _normalizedForwardSpeed;
                }
            }
                ...
                case CharacterState.Default:
                    {
                        ...
                        if (Motor.GroundingStatus.IsStableOnGround)
                        {
                            ...
                            Vector3 localVelocity = Motor.transform.InverseTransformDirection(currentVelocity);
                            _normalizedForwardSpeed = Mathf.Clamp(localVelocity.z / MaxStableMoveSpeed, -1f, 1f);
